  ...
  return (
    <div style={{ background: '#f0f2f0', minHeight: '100vh', padding: '20px 16px' }}>
      <div style={{ maxWidth: '480px', margin: '0 auto' }}>
        ...
        {/* Info bar */}
        <div style={{
          background: '#dcfce7', borderRadius: '10px', padding: '10px 14px',
          ...
          {question.type === 'text' && (
            <textarea
              ...
              style={{
                ...
                border: '2px solid #e5e7eb', fontSize: '14px', fontFamily: 'Inter, sans-serif',
      ...
      {showComplete && (
        <div style={{
          ...
          <div style={{
            background: '#fff', borderRadius: '20px', padding: '40px 28px',
            ...
            <p style={{ fontSize: '32px', fontWeight: 800, color: '#22c55e', marginBottom: '28px' }}>
