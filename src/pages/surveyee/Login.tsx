...
export default function SurveyeeLogin() {
      ...
      <div style={{ maxWidth: '400px', width: '100%', margin: '0 auto', paddingTop: '48px', paddingBottom: '40px' }}>
        ...
        <div style={{ marginBottom: '32px' }}>
          ...
          <p style={{ fontSize: '14px', color: '#9ca3af', margin: 0 }}>
            {mode === 'signin' ? 'Log in to continue earning' : 'Join Surve. and start earning'}
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          {/* Contact toggle + input (signup or as "sign in with") */}
          <div>
                ...
                {(['email', 'phone'] as const).map((m) => (
                  <button
                    ...
                    style={{
                      ...
                      background: contactMethod === m ? '#2d7a4f' : 'transparent',
        ...
        <p style={{ textAlign: 'center', fontSize: '14px', color: '#9ca3af', marginTop: '24px' }}>
          ...
          <span
            ...
            style={{ color: '#2d7a4f', fontWeight: 700, cursor: 'pointer' }}
          >
